					...
					<div class="card-body p-0">
						...
						<div class="row">
							<div class="col-lg-6 d-none d-lg-block">
								<img src="<?= base_url('assets/img/bg-auth.jpg'); ?>" class="img-fluid">
							</div>
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-4">Selamat Datang Admin LPK PEMABA</h1>
									...
									<div class="text-center">
										<a class="small" href="<?= base_url('Web_Public'); ?>">Kembali Ke Halaman Utama</a>
									</div>
								</div>
							</div>
						</div>
