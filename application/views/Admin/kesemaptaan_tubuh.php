...
<div id="content">
    ...
    <div class="container-fluid">
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Tabel Penilaian Kesemaptaan Tubuh</h1>
        <p class="mb-4">Hasil dari Penilaian Kesemaptaan Tubuh :</p>
            ...
            <table class="table table-bordered fixed_header">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col"> Nilai Kesemaptaan Tubuh</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                    $id = 0;
                    foreach ($kesemaptaan as $i):
                        if ($i['kesemaptaan_tubuh'] !== null) {
                            $id++;
                            $nama = $i['nama'];
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Nilai Kesemaptaan Tubuh Pada Alternatif Peserta</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url(); ?>Dashboard/tambah_kesemaptaan_tubuh" enctype="multipart/form-data" method="POST">
                <div class="form-group">
                    ...
                    <select class="form-control" id="id_criteria" name="id_criteria" disabled>
                        ...
                        foreach($kriteria as $i):
                            ...
                            $selected = ($id_criteria == 2) ? 'selected' : '';
                        ?>
                            <option value="<?=$id_criteria ?>" <?=$selected ?>><?=$criteria ?></option>
                        <?php endforeach; ?>
                    </select>
                    <input type="hidden" id="id_criteria" name="id_criteria" value="2">
                </div>
                    <div class="form-group">
