...
<div id="content">
    ...
    <div class="container-fluid">
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Tabel Penilaian Wawancara</h1>
        <p class="mb-4">Hasil dari Penilaian Wawancara :</p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Nilai Wawancara Pada Alternatif Peserta</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url(); ?>Dashboard/tambah_wawancara" enctype="multipart/form-data" method="POST">
                <div class="form-group">
                    ...
                    <select class="form-control" id="id_criteria" name="id_criteria" disabled>
                        ...
                        foreach($kriteria as $i):
                            ...
                            $selected = ($id_criteria == 5) ? 'selected' : '';
                        ?>
                            <option value="<?=$id_criteria ?>" <?=$selected ?>><?=$criteria ?></option>
                        <?php endforeach; ?>
                    </select>
                    <input type="hidden" id="id_criteria" name="id_criteria" value="5">
                </div>
                    <div class="form-group">
